...
But the structure of model is completely changed without separation_kernel layer.
and i have implemented codes for mixed loss function and quantization!
...
class lstm_unet_model():
    '''
    Class to create and train the lstm_unet model
    '''
    ...
    def snr_cost(self, s_estimate, s_true):
        ...
        loss_mse, loss_sisdr, loss_mse_phase, loss_snr_sisdr, loss_mse_compressed, loss_mse_phase_compressed
        are implemented by : kwangyoung kim
        '''
    ...
    def build_lstm_unet_model(self, norm_stft=False, print_on=1):
        '''
    ...
    def build_lstm_unet_model_stateful(self, norm_stft=False):
        '''
    ...
    def create_tf_lite_model(self, weights_file, target_name, use_dynamic_range_quant=False):
        ...
        '''
        # build model    
        self.build_lstm_unet_model_stateful()
        # load weights
        self.model.load_weights(weights_file)
    ...
    def train_model(self, model_dir, runName, path_to_train_mix, path_to_train_speech, \
        ...
        '''
        Method to train the lstm_unet model. 
        '''
