...
path_to_train_mix = 'path to noisy files for training'
# path to folder containing the clean/speech files for training
path_to_train_speech = 'path to clean files for training'
# path to folder containing the noisy or mixed audio validation data
path_to_val_mix = 'path to noisy files for validation'
# path to folder containing the clean audio validation data
path_to_val_speech = 'path to clean files for validation'
